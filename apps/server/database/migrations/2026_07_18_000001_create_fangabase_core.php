...
return new class extends Migration {
    public function up(): void
    {
        ...
        Schema::create('idempotency_keys', function (Blueprint $t): void { $t->uuid('id')->primary(); $t->uuid('owner_id'); $t->string('operation', 80); $t->string('provider', 40); $t->string('idempotency_key', 128); $t->char('body_hash', 64); $t->json('result'); $t->timestampsTz(); $t->unique(['owner_id','operation','provider','idempotency_key'], 'idempotency_scope_unique'); });
    }
