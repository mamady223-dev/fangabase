...
- Tests : 27 tests JS/TS passes; 69 tests PHP et 477 assertions passes; migrations SQLite testees.
...
- Git : checkpoints `b67d885`, `9e54c11`, `0187cb0` et `7860e15` publies sur `origin/main`; jalon 5 prepare pour publication.
