...
- Tests : 26 tests JS/TS passes; 61 tests PHP et 453 assertions passes; migrations SQLite testees.
...
- UAT : Google OAuth reel sans secret dans le depot; Resend/Brevo/SMTP et stockages distants avec comptes reels; concurrence worker et dernier SUPERADMIN sur PostgreSQL/MySQL; Docker, images, restauration live et clone propre en attente.
...
- Git : checkpoints `b67d885`, `9e54c11` et `0187cb0` publies sur `origin/main`; jalon 4 prepare pour publication.
