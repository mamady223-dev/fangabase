...
| 11 - Durcissement                   | Partiel            | Lint, format, typecheck, 32 tests JS/TS, 69 tests PHP/477 assertions, audits                                                               | E2E navigateur, vraie base PostgreSQL/MySQL, performance, SAST/image scan executes               |
...
Les checkpoints `b67d885`, `9e54c11`, `0187cb0`, `7860e15` et `2be77f5` sont publies sur `origin/main`. L'identite Git reste configuree uniquement dans ce depot.
