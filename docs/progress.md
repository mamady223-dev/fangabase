...
| 11 - Durcissement                   | Partiel            | Lint, format, typecheck, 26 tests JS/TS, 61 tests PHP/453 assertions, audits                                                               | E2E navigateur, vraie base PostgreSQL/MySQL, performance, SAST/image scan executes    |
...
Les checkpoints `b67d885`, `9e54c11` et `0187cb0` sont publies sur `origin/main`. L'identite Git reste configuree uniquement dans ce depot.

## Prochain lot exact

Jalon 5 : brancher les abonnements, entitlements et credits persistants aux API et a l'interface. Les recettes fournisseurs, les clients officiels de stockage distant et la concurrence multi-worker PostgreSQL/MySQL restent UAT avec comptes ou Docker.
